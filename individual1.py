...
if __name__ == '__main__':
    r1 = Payment(full_name="Albert", salary=45000, year=2018, percent=10, daysworked=20, workingdays=23)
    r2 = Payment(full_name="Albert", salary=30000, year=2019, percent=5, daysworked=19, workingdays=23)
    ...
    print(f"Разница в заработной плате (деление): {r1 / r2}")
    print(f"Добавление рабочих дней: {r1 + r2}")
    print(f"Разница в отработанных днях (вычитание): {r1 - r2}")